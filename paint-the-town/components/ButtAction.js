...
const ButtAction = ({colour, navigation, changeColour, stop, start, pause}) => {
    ...
    return (
        <ActionButton buttonColor= {`rgba(${rgb.red},${rgb.green},${rgb.blue},${rgb.alpha})`} radius={90} position='center' degrees={270} icon={ <Icon name="md-brush" style={styles.actionButtonIcon}/>}outRangeScale={0.8} style={{position:'absolute', top: 200, left: 50, zIndex: 10}}>
          <ActionButton.Item buttonColor='#228B22' title="Start" size={60} onPress={start} style={{zIndex: 10}}>
            <Icon name="md-play" style={styles.actionButtonIcon} />
          </ActionButton.Item>
          <ActionButton.Item buttonColor='#3498db' title="Pause" size={60} onPress={pause} style={{zIndex: 10}}>
            <Icon name="md-pause" style={styles.actionButtonIcon} />
          </ActionButton.Item>
          <ActionButton.Item buttonColor='#E74C3C' title="Stop" size={60} onPress={stop} style={{zIndex: 10}}>
